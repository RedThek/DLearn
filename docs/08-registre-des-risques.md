...
| R-02 | Fragmentation du parc Android (versions, résolutions, RAM) rend certains comportements imprévisibles | Élevée | Moyen | Modérée | **Tranché (ADR-005)** : `minSdkVersion = 28` fixé sur constat terrain direct. Tester néanmoins sur au moins 2 profils de devices (Android 9 bas de gamme / plus récent) | Sous contrôle | NFR-04, NFR-06 |
